const {
  ...
  module.exports = {
    data: new SlashCommandBuilder()
      .setName("ban")
      .setDescription("Bloquea del servidor a un usuario")
      .addMentionableOption(option =>
        option.setName("user")
          .setDescription("Selecciona al usuario que será baneado")
          .setRequired(true))
    ...
    async execute(interaction, client) {
      ...
      registro.findOne({ usuario: tonto, guild: interaction.guild.id }, async (err, data) => {
        ...
        guild.members.ban(persona, { reason: `${interaction.user.username} - ${motivowe}` })
        ...
        return interaction.reply({
            content: `<:warningf:1109631272529186928> Ha ocurrido un error al aplicar la sancion al usuario, comprueba que mi rango sea mayor al usuario seleccionado`,
            ephemeral: true
            })
