...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    if (interaction.member.roles.highest.position < persona.roles.highest.position) return interaction.reply({ content: `<:warningf:1109631272529186928> El usuario <@${persona.id}> tiene un rango mayor al tuyo`, ephemeral: true });
